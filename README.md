...
| [Arquiteturas Evolutivas com IA](https://www.techleads.club/c/arquiteturas-evolutivas-com-ia) por Waldemar Neto | `Avançado` `Curso` `Pago` |
...
| [Big-O no Dia a Dia](https://www.youtube.com/watch?v=2NHnfnNE0wk) por Evelyn Mendes | `Iniciante` `Vídeo` `Grátis` |
...
| [Como Escalar Monólitos Modulares: O Guia Completo](https://www.youtube.com/watch?v=bliiVueOVpU) por Waldemar Neto | `Intermediário` `Vídeo` `Grátis` |
...
| [Databases, distributed systems, software engineering](https://www.youtube.com/@benjdicken) por Ben Dicken | `Intermediário` `Vídeo` `Grátis` |
...
| [Design for Failure: Como Assim Meu Sistema Falha?](https://www.youtube.com/watch?v=eKcSbxl0RPs) por Luiz Schons | `Site Reliability Engineering` `Intermediário` `Vídeo` `Grátis` |
...
| [Event Storming na Prática: Desvendando Domínios Complexos com Colaboração e Agilidade](https://www.youtube.com/watch?v=NP4bmgG4SV0) por Samuel Nascimento | `Intermediário` `Vídeo` `Grátis` |
...
| [Ferramentas, Práticas e Tendências na era da IA com Rodrigo Branas](https://www.youtube.com/watch?v=ZPtK2f6WwUg) por Waldemar Neto | `Intermediário` `Vídeo` `Grátis` |
...
| [IA para Devs: Dos Fundamentos às Ferramentas e Práticas que Aumentam Produtividade](https://www.youtube.com/watch?v=90lGnXnMqgo) por Waldemar Neto | `Intermediário` `Vídeo` `Grátis` |
...
| [Multitenancy na Prática: Como Spring pode Contribuir na Arquitetura Inteligente para Aplicações SaaS](https://www.youtube.com/watch?v=X38znLeXtsU) por Anderson Garcia | `Intermediário` `Vídeo` `Grátis` |
| [Não é magia, é elasticsearch!](https://www.youtube.com/watch?v=W1YvnzBExeQ) por Rodrigo Klaes | `Intermediário` `Vídeo` `Grátis` |
...
| [Reflexões sobre Coesão e Acoplamento de Software](https://www.youtube.com/watch?v=hk8Nq7UNYY0) por Marcel Santos | `Arquitetura e Design` `Avançado` `Vídeo` `Grátis` |
...
| [SAST, DAST e Além: Construindo um Ciclo de Vida de Software Seguro](https://www.youtube.com/watch?v=H8L842PhfXc) por William Fernandes | `Avançado` `Vídeo` `Grátis` |
...
| [Site Reliability Engineering: How Google Runs Production Systems - Google SRE Team](https://www.amazon.com.br/Site-Reliability-Engineering-Production-Systems-ebook/dp/B01DCPXKZ6/ref=tmm_kin_swatch_0?_encoding=UTF8&dib_tag=se&dib=eyJ2IjoiMSJ9.qI7Oz3BO-9LLMjJ4XMORPb6OEA0x1uakatS7uikyJyex96BfP9nm77bDQhWj3Rw2jSmH_Y9AnHjIQHhIffmIFoYVLN9oXUo7m9YkLfPEhSc3e9ulmfRPvt5wUDWdkkM7.2MiKPMrXDUL2s1BDxb4eBFBQ3ZEDGdVaOOYHxVIaNhY&qid=1737233771&sr=8-1) por Niall Richard Murphy, Betsy Beyer, Chris Jones, Jennifer Petoff  | `Site Reliability Engineering` `Intermediário` `Livro` `Pago` |
...
| [Trilha Desenvolvimento Assistido por IA](https://www.techleads.club/c/trilha-desenvolvimento-assistido-por-ia) por Tech Leads Club | `Intermediário` `Roadmap` `Pago` |
| [Trilha Liderança de Alta Performance](https://www.techleads.club/c/trilha-lideranca-de-alta-performance) por Tech Leads Club | `Intermediário` `Roadmap` `Pago` |
...
| [Formação em Feature Leading](https://www.techleads.club/c/formacao-em-feature-leading) por Waldemar Neto | `Intermediário` `Curso` `Pago` |
...
| [O Erro Oculto que Trava o Crescimento de Desenvolvedores](https://www.youtube.com/watch?v=jehsLnGF2ns) por Felipe Adamoli | `Carreira` `Intermediário` `Vídeo` `Grátis` |
| [Os Desafios do Go To Market no Ecossistema Tech Brasileiro](https://www.youtube.com/watch?v=8fGmmLW1Qpw) por Moyses Viana | `Intermediário` `Vídeo` `Grátis` |
...
| [Como Aprender Soft Skills Como Dev (Tratando Elas Como Hard Skills)](https://www.youtube.com/watch?v=7tB4SQWTJoE) por Felipe Adamoli | `Carreira` `Intermediário` `Vídeo` `Grátis` |
...
| [Como ser reconhecido no trabalho?](https://www.youtube.com/watch?v=iK08Kbjcd_k) por Jorge Leite | `Iniciante` `Vídeo` `Grátis` |
| [Comunique-se Melhor Com Todas as Camadas da Organização](https://www.youtube.com/watch?v=kGYIRLSk8fY) por Gabriel Lisboa | `Intermediário` `Vídeo` `Grátis` |
...
| [Gerenciamento de Carreira](https://www.techleads.club/c/gerenciamento-de-carreira) por Waldemar Neto | `Intermediário` `Curso` `Pago` |
| [Gestão De Stakeholders](https://www.techleads.club/c/gestao-de-stakeholders) por Felipe Adamoli, Alexandre Klaser | `Avançado` `Curso` `Pago` |
...
| [On Pair Programming](https://martinfowler.com/articles/on-pair-programming.html) por Birgitta Böckeler, Nina Siessegger | `Intermediário` `Artigo` `Grátis` |
| [Pare de Travar a evolução do seu Time Técnico](https://www.youtube.com/watch?v=hlCLAg3hkMA) por Felipe Adamoli | `Intermediário` `Vídeo` `Grátis` |
| [Por que muitos devs não evoluem para sênior](https://www.youtube.com/watch?v=MfY7GitO5-c) por Felipe Adamoli | `Carreira` `Iniciante` `Vídeo` `Grátis` |
| [Por que Tech Leads "Bonzinhos" Fracassam](https://www.youtube.com/watch?v=LrAzPbbWRqk) por Felipe Adamoli | `Intermediário` `Vídeo` `Grátis` |
...
| [Ser Tech Lead não é sobre resolver tudo sozinho](https://www.youtube.com/watch?v=TwMlcc73gtg) por Felipe Adamoli | `Intermediário` `Vídeo` `Grátis` |
...
| [The Startup CTO's Handbook](https://github.com/ZachGoldberg/Startup-CTO-Handbook/blob/main/StartupCTOHandbook.md) por Zach Goldberg | `Avançado` `Livro` `Grátis` |
| [The Team that Managed Itself: A Story of Leadership](https://www.goodreads.com/book/show/53108540-the-team-that-managed-itself?from_search=true&from_srp=true&qid=L7C8WR5EMN&rank=1) por Christina Wodtke  | `Intermediário` `Livro` `Pago` |
| [Você é um IMPOSTOR na Sua Carreira em Tech? (E como parar já!)](https://www.youtube.com/watch?v=4lKk0Gq8GwQ) por Felipe Adamoli | `Carreira` `Iniciante` `Vídeo` `Grátis` |

...
| [Looks good to me is a lazy default - Why managers should give feedback on work output](https://newsletter.weskao.com/p/looks-good-to-me-is-a-lazy-default-managers-should-give-feedback/) por Wes Kao | `Liderança` `Feedbacks` `Qualidade` `Avançado` `Artigo` `Grátis` |
